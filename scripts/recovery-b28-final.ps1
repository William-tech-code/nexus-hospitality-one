...
Write-Host " V2.3.0-B28 - SMART POS FINAL RECOVERY" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
...
$backup=".\backups\V2.3.0-B28-MASTER-$stamp"
...
Write-Host " B28 FINAL FRONTEND RECOVERY = PASS" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
