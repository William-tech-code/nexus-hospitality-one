...
Write-Host " V2.3.0-B27 - FINAL TERNARY RECOVERY" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
...
$backup=".\backups\V2.3.0-B27-MASTER-$stamp"
...
Write-Host " B27 FINAL FRONTEND RECOVERY = PASS" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
