...
Write-Host " V2.3.0-B26 - FINAL MASTER FRONTEND RECOVERY" -ForegroundColor Yellow
Write-Host "============================================================" -ForegroundColor Cyan
...
$backup=".\backups\V2.3.0-B26-MASTER-$stamp"
...
Write-Host " B26 FINAL MASTER FRONTEND RECOVERY = PASS" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
